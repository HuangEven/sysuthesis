...
为便于综合展示，表~\ref{tab:core-summary} 汇总了核心结果，图~\ref{fig:fusion-vs-baselines}、图~\ref{fig:single-gpu-before-after}、图~\ref{fig:multi-gpu-scaling} 和图~\ref{fig:scale-comparison} 分别对应总体对比、单卡优化、多 GPU 扩展以及跨规模表现四个观察视角。
